...
## Files Updated
- source/isaaclab_tasks/isaaclab_tasks/direct/go2/go2_env_cfg.py:120
  - Inserted a `sim = Go2FlatEnvCfg.sim.replace(...)` override inside `Go2RoughEnvCfg` that sets `physx.gpu_max_rigid_patch_count` to `12 * 2**15` (393,216) instead of the default 163,840.
